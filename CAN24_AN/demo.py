...
def main_network(args):
    ...
    if args.preload and args.is_train:
        ...
        output_images = np.empty([len(input_names), output_pl.shape[1].value, output_pl.shape[2].value, 3])
